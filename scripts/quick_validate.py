...
def main():
    ...
    if check_exists("SKILL.md"):
        ...
        checks.append(("SKILL includes Presenter + Vendor + Customer Mode", "Presenter + Vendor + Customer Mode" in skill))
        checks.append(("SKILL separates presenter, vendor, customer, and demo context", "Presenter Context" in skill and "Vendor / Seller Context" in skill and "Customer / Target Account Context" in skill and "Demo Context" in skill))
        checks.append(("SKILL does not assume OpenAI product", "do not assume the demo is ChatGPT" in skill))
